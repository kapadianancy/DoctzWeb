...
@NamedQueries({
    ...
    @NamedQuery(name = "DoctorScheduleTb.findByAvailabilityOfBooking", query = "SELECT d.doctorId FROM DoctorScheduleTb d GROUP BY d.doctorId ORDER BY sum(d.numberOfPatient) DESC"),
